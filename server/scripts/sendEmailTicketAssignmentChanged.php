...
// sendEmailTicketAssignmentChanged.php
//		Used to send a email notice to a user that their ticket assignment has had information changed on it.
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
$mailTo = $argumentMailTo;
    $mailFrom = "jabucar@huntinglake.com";        
        $mailSubject = "Event Ticketing System: Ticket Assignment #" + $argumentAssignmentNumber + " has had informed changed on it.";
            $mailMessage = "Hello! This is a test email message.   Had this been an actual email you would get information on the ticket assignment that was changed.";
