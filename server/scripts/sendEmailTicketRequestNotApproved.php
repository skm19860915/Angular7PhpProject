...
// sendEmailTicketRequestNotApproved.php
//		Used to send a email notice to a user that their ticket request has NOT been approved.
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
$mailTo = $argumentMailTo;
    $mailFrom = "jabucar@huntinglake.com";        
        $mailSubject = "Event Ticketing System: Your Ticket Request #" + $argumentRequestNumber + " has NOT been approved in the system.";
            $mailMessage = "Hello! This is a test email message.   Had this been an actual email you would get information on the ticket request that WAS NOT approved.";
