...
// getAllFoodOrderCategories.php
//		Used to return a list of all the valid Food Order Categories in the system
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
/* SQL Statement */
$tsql = "SELECT * FROM " + DB_TABLELIST_FOOD_ORDER_CATEGORIES + " ORDER BY Category";
