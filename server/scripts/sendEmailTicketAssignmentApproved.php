...
if ($argumentAssignmentNumber == '')	
	{	echo "ERROR0003: No Assignment Number Parameter Specified."; die();	}

// Set up the mail arguments

$mailTo = $argumentMailTo;
    $mailFrom = "jabucar@huntinglake.com";        
        $mailSubject = "Event Ticketing System: Ticket Request #" + $argumentRequestNumber + " has been approved and has been assigned Ticket Assignment #" + $argumentAssignmentNumber + ".";
            $mailMessage = "Hello! This is a test email message.   Had this been an actual email you would get information on the ticket approval you or someone placed for you.";
