...
// getAllTicketCategories.php
//		Used to return a list of all the valid Ticket Categories in the system
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
/* SQL Statement */
$tsql = "SELECT * FROM " . DB_TABLELIST_TICKET_CATEGORIES . " ORDER BY Category";
