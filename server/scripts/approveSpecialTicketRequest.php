...
// approveSpecialTicketRequest.php
// Used to approve a special ticket request in the system.
//
// Walter | Haverfield
// 
...
// If SpecialRequestNumber is unset lets refuse request.
  ...
  logAction ( $logAction, "Starting special ticket request approval" );
  ...
  if( $sqlData === false ) {
    ...
    logAction( $logAction, "Special ticket request $input->SpecialRequestNumber was successfully approved." );
