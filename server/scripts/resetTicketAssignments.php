...
// resetTicketAssignments.php
//		Deletes all ticket assignments, and sets all ticket statuses back to available.
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
// Delete all ticket requests
        ...
        $sqlStatement  = "DELETE FROM [" . DB_TABLE_TICKET_ASSIGNMENTS . "];";
    ...
    // Step 2: Reset all ticket status to AVAILABLE
        ...
        // Step 2: Send notification email(s)
            ...
            include 'sendEmailNotification.php';
                ...
                sendEmailTicketAssignmentsInit($sendEmailTo,9999);
