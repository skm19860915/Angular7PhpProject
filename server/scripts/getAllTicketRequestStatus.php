...
// getAllTicketRequestStatus.php
//		Used to return a list of all the valid Ticket Request statuses in the system
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
/* SQL Statement */
$tsql = "SELECT * FROM " + DB_TABLELIST_TICKET_REQUEST_STATUS + " ORDER BY Status";
