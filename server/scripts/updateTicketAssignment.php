...
// 2) Add log record
    ...
    updateTicketAssignment($json);

    // Step 2: Add a log record

    $logMessage = "Ticket Assignment (#" . $json->AssignmentNumber . ") has been updated with new data. ";
            logAction("UPDATE TICKET ASSIGNMENT", $logMessage);
