...
// getAllTicketAssignmentStatus.php
//		Used to return a list of all the valid Ticket Assignment statuses in the system
//
// Walter | Haverfield
// 
// Author:  Joseph Bucar
...
/* SQL Statement */
$tsql = "SELECT * FROM " + DB_TABLELIST_TICKET_ASSIGNMENTS_STATUS + " ORDER BY Status";
